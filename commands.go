	...
	for _, command := range commands {
		...
		case "touch":
			if len(command) == 5 {
				...
				if !inputSdkInjectTouchEvent(0, x, y, width, height) {
					return
				}

				if !inputSdkInjectTouchEvent(1, x, y, width, height) {
					return
				}
			} else {
				return
		...
		case "touchmove":
			if len(command) == 5 {
				...
				if !inputSdkInjectTouchEvent(2, x, y, width, height) {
					return
				}
			} else {
				return
		...
		case "mouseclick":
			if len(command) == 4 {
				...
				if !inputSdkInjectMouseEvent(0, x, y, width, height, button) {
					return
				}

				if !inputSdkInjectMouseEvent(1, x, y, width, height, button) {
					return
				}
			} else {
				return
		...
		case "mousedown":
			if len(command) == 4 {
				...
				if !inputSdkInjectMouseEvent(0, x, y, width, height, inputGetMouseButton(command[1])) {
					return
				}
			} else {
				return
		...
		case "mouseup":
			if len(command) == 1 {
				...
				if !inputSdkInjectMouseEvent(1, x, y, width, height, inputGetMouseButton(command[1])) {
					return
				}
			} else {
				return
		...
		case "mousemove":
			if len(command) == 3 {
				...
				if !inputSdkInjectMouseEvent(2, x, y, width, height, inputGetMouseButton(command[1])) {
					return
				}
			} else {
				return
