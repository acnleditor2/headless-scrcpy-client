...
func sendVideoStream(w http.ResponseWriter, req *http.Request, header bool) {
...
func sendRgbVideoStream(w http.ResponseWriter, req *http.Request) {
	if !config.Scrcpy.Video || !config.VideoDecoder.Enabled || !config.VideoDecoder.Stream {
		w.WriteHeader(http.StatusNotFound)
		return
	}
...
func sendFfmpegRgbVideoStream(w http.ResponseWriter, req *http.Request) {
	if !config.Scrcpy.Video || !config.VideoDecoder.Enabled || !config.VideoDecoder.Stream {
		w.WriteHeader(http.StatusNotFound)
		return
	}
...
func sendVideoFrame(w http.ResponseWriter, req *http.Request) {
	if !config.Scrcpy.Video || !config.VideoDecoder.Enabled || config.VideoDecoder.Stream {
		w.WriteHeader(http.StatusNotFound)
		return
	}
